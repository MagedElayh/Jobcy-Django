...
gulp.task('build', gulp.series(gulp.parallel('clean:packageLock', 'clean:static', 'copy:all', 'copy:libs'), 'scss'));

// gulp.task('default', gulp.series(gulp.parallel('fileinclude', 'scss'), gulp.parallel('browsersync', 'watch')));
gulp.task('default', gulp.series(gulp.parallel('clean:packageLock', 'clean:static', 'copy:all', 'copy:libs', 'scss', 'js', 'jsPages'), gulp.parallel('watch')));